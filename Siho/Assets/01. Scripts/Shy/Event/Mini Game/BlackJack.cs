...
namespace Shy.Event
{
    ...
    {
        [SerializeField] private BlackJackCard playerCard, enemyCard;
        [SerializeField][Range(1, 6)] private int maxCnt;
        [SerializeField] private Sprite[] diceEyes;
        [SerializeField] private BlackJackButton playBt, stopBt, stayBt, exitBt;
        [SerializeField] private TextMeshProUGUI tmp, rewardTmp;
